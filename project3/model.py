...
def train(prof_train, val_train, check_point=None,
          learning_rate=0.00001, batch_size=8, epochs=600, print_iteration=40):
    network = UNet(encoder_args=(1, 64, 128, 256, 512, 1024),
                   decoder_args=(1024, 512, 256, 128, 64))
    ...
    model_save_folder = "./Trained_small_model_512_euler/signal_unet_smaller/"
    if not os.path.exists(model_save_folder):
        os.makedirs(model_save_folder)

    if check_point:
        network.load_state_dict(torch.load('Trained_small_model_512_euler/signal_unet_smaller/{}.pth'.format(check_point)))
